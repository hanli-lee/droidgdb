...
source_dir="/home/mi/disk2/9.0/F1/"
...
SCRIPT_FILE = CURRENT_DIR + "/art/init.gdb"
...
#SHADOW_FILE = CURRENT_DIR + "/shadow-master/gdb_driver.py"
SHADOW_FILE = CURRENT_DIR + "/art/command_file.py"
...
#            print "pid: " + pid
    ...
    parent = get_proc_name(ppid).split()[0]

    print 'process: ' + proc_name[0] + ", pid(" + pid + "), parent(" + parent + ")"
